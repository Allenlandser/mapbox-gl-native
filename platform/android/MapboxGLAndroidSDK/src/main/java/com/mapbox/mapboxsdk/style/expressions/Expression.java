...
public class Expression {
  ...
  public Expression(String operator, Object... values) {
    this.operator = operator;
    this.values = values;
  }

  public Object[] toArray() {
    ArrayList<Object> array = new ArrayList<>(1 + values.length);
    array.add(operator);
    for (Object o : values) {
   ...
   * @return
   */
  public static Expression ln2(Object... expressions) {
    return new Expression("ln2", expressions);
  }
   ...
   * @return
   */
  public static Expression pi(Object... expressions) {
    return new Expression("pi", expressions);
  }
   ...
   * @return
   */
  public static Expression e(Object... expressions) {
    return new Expression("e", expressions);
  }
